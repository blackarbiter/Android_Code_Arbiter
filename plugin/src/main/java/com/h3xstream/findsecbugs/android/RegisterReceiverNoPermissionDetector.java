...
/**
 * Created by lee on 17/8/2.
 */
public class RegisterReceiverNoPermissionDetector extends OpcodeStackDetector{
    private static final String ANDROID_REGISTER_RECEIVER_NOPERMISSION_TYPE = "ANDROID_REGISTER_RECEIVER_NOPERMISSION";
    private BugReporter bugReporter;

    public RegisterReceiverNoPermissionDetector(BugReporter bugReporter) {
